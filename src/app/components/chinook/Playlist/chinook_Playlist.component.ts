...
import { EditChinook_PlaylistComponent } from './modals/edit.chinook_Playlist.component';
import { HttpService } from 'src/app/services/http-service';
import { AuthService } from 'src/app/services/auth-service';

/**
 * "Datagrid" component for displaying instance of Playlist
 * entities from your HTTP REST backend.
 */
@Component({
  selector: 'app-chinook_Playlist',
  templateUrl: './chinook_Playlist.component.html',
  styleUrls: ['./chinook_Playlist.component.scss'],
  animations: [
...
export class Chinook_PlaylistComponent extends GridComponent implements OnInit {
  ...
  public entityBaseUrl() {
    return 'magic/modules/chinook/Playlist';
  }
  ...
  protected read(filter: any) {
    return this.httpService.chinook_Playlist.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.chinook_Playlist.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.chinook_Playlist.delete(ids);
  }
  ...
  public ngOnInit() {
     ...
     * on our columns.
     */
    this.Name = this.createFormControl('Playlist.Name.like');
    this.PlaylistId = this.createFormControl('Playlist.PlaylistId.eq');
  }
  ...
  public editEntity(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditChinook_PlaylistComponent, {
