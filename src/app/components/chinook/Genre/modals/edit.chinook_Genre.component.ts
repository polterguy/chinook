...
/**
 * Modal dialog for editing your existing Genre entity types, and/or
 * creating new entity types of type Genre.
 */
@Component({
  templateUrl: './edit.chinook_Genre.component.html'
})
export class EditChinook_GenreComponent extends DialogComponent {

  /**
   * Constructor taking a bunch of services injected using dependency injection.
   */
  constructor(
    public dialogRef: MatDialogRef<EditChinook_GenreComponent>,
    @Inject(MAT_DIALOG_DATA) public data: DialogData,
    protected snackBar: MatSnackBar,
    public service: HttpService) {
    super(snackBar);
    this.primaryKeys = ['GenreId'];
    this.createColumns = [
      'Name',
      'GenreId'
    ];
  ...
  protected getUpdateMethod() {
    return this.service.chinook_Genre.update(this.data.entity);
  }
  /**
   * Returns a reference to the create method, to create new entities.
   */
  protected getCreateMethod() {
    return this.service.chinook_Genre.create(this.data.entity);
  }
