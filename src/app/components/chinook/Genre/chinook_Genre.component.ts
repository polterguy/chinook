...
import { EditChinook_GenreComponent } from './modals/edit.chinook_Genre.component';
import { HttpService } from 'src/app/services/http-service';
import { AuthService } from 'src/app/services/auth-service';

/**
 * "Datagrid" component for displaying instance of Genre
 * entities from your HTTP REST backend.
 */
@Component({
  selector: 'app-chinook_Genre',
  templateUrl: './chinook_Genre.component.html',
  styleUrls: ['./chinook_Genre.component.scss'],
  animations: [
...
export class Chinook_GenreComponent extends GridComponent implements OnInit {
  ...
  public entityBaseUrl() {
    return 'magic/modules/chinook/Genre';
  }
  ...
  protected read(filter: any) {
    return this.httpService.chinook_Genre.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.chinook_Genre.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.chinook_Genre.delete(ids);
  }
  ...
  public ngOnInit() {
     ...
     * on our columns.
     */
    this.Name = this.createFormControl('Genre.Name.like');
    this.GenreId = this.createFormControl('Genre.GenreId.eq');
  }
  ...
  public editEntity(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditChinook_GenreComponent, {
