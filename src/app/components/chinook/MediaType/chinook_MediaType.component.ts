...
import { EditChinook_MediaTypeComponent } from './modals/edit.chinook_MediaType.component';
import { HttpService } from 'src/app/services/http-service';
import { AuthService } from 'src/app/services/auth-service';

/**
 * "Datagrid" component for displaying instance of MediaType
 * entities from your HTTP REST backend.
 */
@Component({
  selector: 'app-chinook_MediaType',
  templateUrl: './chinook_MediaType.component.html',
  styleUrls: ['./chinook_MediaType.component.scss'],
  animations: [
...
export class Chinook_MediaTypeComponent extends GridComponent implements OnInit {
  ...
  public entityBaseUrl() {
    return 'magic/modules/chinook/MediaType';
  }
  ...
  protected read(filter: any) {
    return this.httpService.chinook_MediaType.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.chinook_MediaType.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.chinook_MediaType.delete(ids);
  }
  ...
  public ngOnInit() {
     ...
     * on our columns.
     */
    this.Name = this.createFormControl('MediaType.Name.like');
    this.MediaTypeId = this.createFormControl('MediaType.MediaTypeId.eq');
  }
  ...
  public editEntity(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditChinook_MediaTypeComponent, {
