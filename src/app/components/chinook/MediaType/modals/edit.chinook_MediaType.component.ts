...
/**
 * Modal dialog for editing your existing MediaType entity types, and/or
 * creating new entity types of type MediaType.
 */
@Component({
  templateUrl: './edit.chinook_MediaType.component.html'
})
export class EditChinook_MediaTypeComponent extends DialogComponent {

  /**
   * Constructor taking a bunch of services injected using dependency injection.
   */
  constructor(
    public dialogRef: MatDialogRef<EditChinook_MediaTypeComponent>,
    @Inject(MAT_DIALOG_DATA) public data: DialogData,
    protected snackBar: MatSnackBar,
    public service: HttpService) {
    super(snackBar);
    this.primaryKeys = ['MediaTypeId'];
    this.createColumns = [
      'Name',
      'MediaTypeId'
    ];
  ...
  protected getUpdateMethod() {
    return this.service.chinook_MediaType.update(this.data.entity);
  }
  /**
   * Returns a reference to the create method, to create new entities.
   */
  protected getCreateMethod() {
    return this.service.chinook_MediaType.create(this.data.entity);
  }
