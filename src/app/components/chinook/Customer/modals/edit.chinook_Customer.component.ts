 ...
 */
@Component({
  templateUrl: './edit.chinook_Customer.component.html'
})
export class EditChinook_CustomerComponent extends DialogComponent {

  /**
   * Constructor taking a bunch of services injected using dependency injection.
   */
  constructor(
    public dialogRef: MatDialogRef<EditChinook_CustomerComponent>,
  ...
  protected getUpdateMethod() {
    return this.service.chinook_Customer.update(this.data.entity);
  }
  /**
   * Returns a reference to the create method, to create new entities.
   */
  protected getCreateMethod() {
    return this.service.chinook_Customer.create(this.data.entity);
  }
