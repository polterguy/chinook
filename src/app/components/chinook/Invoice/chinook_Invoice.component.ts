...
import { EditChinook_InvoiceComponent } from './modals/edit.chinook_Invoice.component';
import { HttpService } from 'src/app/services/http-service';
import { AuthService } from 'src/app/services/auth-service';

/**
 * "Datagrid" component for displaying instance of Invoice
 * entities from your HTTP REST backend.
 */
@Component({
  selector: 'app-chinook_Invoice',
  templateUrl: './chinook_Invoice.component.html',
  styleUrls: ['./chinook_Invoice.component.scss'],
  animations: [
...
export class Chinook_InvoiceComponent extends GridComponent implements OnInit {
  ...
  public CustomerId_FirstName: FormControl;
  ...
  public BillingPostalCode: FormControl;
  public InvoiceDate: FormControl;
  ...
  public entityBaseUrl() {
    return 'magic/modules/chinook/Invoice';
  }
  ...
  protected read(filter: any) {
    return this.httpService.chinook_Invoice.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.chinook_Invoice.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.chinook_Invoice.delete(ids);
  }
  ...
  public ngOnInit() {
     ...
     * on our columns.
     */
    this.CustomerId_FirstName = this.createFormControl('CustomerId.FirstName.like');
    this.BillingAddress = this.createFormControl('Invoice.BillingAddress.like');
    this.BillingCity = this.createFormControl('Invoice.BillingCity.like');
    this.BillingState = this.createFormControl('Invoice.BillingState.like');
    this.BillingCountry = this.createFormControl('Invoice.BillingCountry.like');
    this.BillingPostalCode = this.createFormControl('Invoice.BillingPostalCode.like');
    this.InvoiceDate = this.createFormControl('Invoice.InvoiceDate.eq');
    this.InvoiceId = this.createFormControl('Invoice.InvoiceId.eq');
    this.CustomerId = this.createFormControl('Invoice.CustomerId.eq');
    this.Total = this.createFormControl('Invoice.Total.eq');
  }
  ...
  public editEntity(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditChinook_InvoiceComponent, {
