...
import { EditChinook_ArtistComponent } from './modals/edit.chinook_Artist.component';
import { HttpService } from 'src/app/services/http-service';
import { AuthService } from 'src/app/services/auth-service';

/**
 * "Datagrid" component for displaying instance of Artist
 * entities from your HTTP REST backend.
 */
@Component({
  selector: 'app-chinook_Artist',
  templateUrl: './chinook_Artist.component.html',
  styleUrls: ['./chinook_Artist.component.scss'],
  animations: [
...
export class Chinook_ArtistComponent extends GridComponent implements OnInit {
  ...
  public entityBaseUrl() {
    return 'magic/modules/chinook/Artist';
  }
  ...
  protected read(filter: any) {
    return this.httpService.chinook_Artist.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.chinook_Artist.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.chinook_Artist.delete(ids);
  }
  ...
  public ngOnInit() {
     ...
     * on our columns.
     */
    this.Name = this.createFormControl('Artist.Name.like');
    this.ArtistId = this.createFormControl('Artist.ArtistId.eq');
  }
  ...
  public editEntity(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditChinook_ArtistComponent, {
