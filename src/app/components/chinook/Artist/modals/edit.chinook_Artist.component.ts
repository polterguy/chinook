...
/**
 * Modal dialog for editing your existing Artist entity types, and/or
 * creating new entity types of type Artist.
 */
@Component({
  templateUrl: './edit.chinook_Artist.component.html'
})
export class EditChinook_ArtistComponent extends DialogComponent {

  /**
   * Constructor taking a bunch of services injected using dependency injection.
   */
  constructor(
    public dialogRef: MatDialogRef<EditChinook_ArtistComponent>,
    @Inject(MAT_DIALOG_DATA) public data: DialogData,
    protected snackBar: MatSnackBar,
    public service: HttpService) {
    super(snackBar);
    this.primaryKeys = ['ArtistId'];
    this.createColumns = [
      'Name',
      'ArtistId'
    ];
  ...
  protected getUpdateMethod() {
    return this.service.chinook_Artist.update(this.data.entity);
  }
  /**
   * Returns a reference to the create method, to create new entities.
   */
  protected getCreateMethod() {
    return this.service.chinook_Artist.create(this.data.entity);
  }
