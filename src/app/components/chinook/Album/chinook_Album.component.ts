...
import { EditChinook_AlbumComponent } from './modals/edit.chinook_Album.component';
import { HttpService } from 'src/app/services/http-service';
import { AuthService } from 'src/app/services/auth-service';

/**
 * "Datagrid" component for displaying instance of Album
 * entities from your HTTP REST backend.
 */
@Component({
  selector: 'app-chinook_Album',
  templateUrl: './chinook_Album.component.html',
  styleUrls: ['./chinook_Album.component.scss'],
  animations: [
...
export class Chinook_AlbumComponent extends GridComponent implements OnInit {
  ...
  public ArtistId_Name: FormControl;
  public Title: FormControl;
  public AlbumId: FormControl;
  public ArtistId: FormControl;
  ...
  public entityBaseUrl() {
    return 'magic/modules/chinook/Album';
  }
  ...
  protected read(filter: any) {
    return this.httpService.chinook_Album.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.chinook_Album.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.chinook_Album.delete(ids);
  }
  ...
  public ngOnInit() {
     ...
     * on our columns.
     */
    this.ArtistId_Name = this.createFormControl('ArtistId.Name.like');
    this.Title = this.createFormControl('Album.Title.like');
    this.AlbumId = this.createFormControl('Album.AlbumId.eq');
    this.ArtistId = this.createFormControl('Album.ArtistId.eq');
  }
  ...
  public editEntity(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditChinook_AlbumComponent, {
