...
import { EditChinook_InvoiceLineComponent } from './modals/edit.chinook_InvoiceLine.component';
import { HttpService } from 'src/app/services/http-service';
import { AuthService } from 'src/app/services/auth-service';

/**
 * "Datagrid" component for displaying instance of InvoiceLine
 * entities from your HTTP REST backend.
 */
@Component({
  selector: 'app-chinook_InvoiceLine',
  templateUrl: './chinook_InvoiceLine.component.html',
  styleUrls: ['./chinook_InvoiceLine.component.scss'],
  animations: [
...
export class Chinook_InvoiceLineComponent extends GridComponent implements OnInit {
  ...
  public InvoiceId_BillingAddress: FormControl;
  public TrackId_Name: FormControl;
  public InvoiceLineId: FormControl;
  ...
  public entityBaseUrl() {
    return 'magic/modules/chinook/InvoiceLine';
  }
  ...
  protected read(filter: any) {
    return this.httpService.chinook_InvoiceLine.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.chinook_InvoiceLine.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.chinook_InvoiceLine.delete(ids);
  }
  ...
  public ngOnInit() {
     ...
     * on our columns.
     */
    this.InvoiceId_BillingAddress = this.createFormControl('InvoiceId.BillingAddress.like');
    this.TrackId_Name = this.createFormControl('TrackId.Name.like');
    this.InvoiceLineId = this.createFormControl('InvoiceLine.InvoiceLineId.eq');
    this.InvoiceId = this.createFormControl('InvoiceLine.InvoiceId.eq');
    this.TrackId = this.createFormControl('InvoiceLine.TrackId.eq');
    this.UnitPrice = this.createFormControl('InvoiceLine.UnitPrice.eq');
    this.Quantity = this.createFormControl('InvoiceLine.Quantity.eq');
  }
  ...
  public editEntity(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditChinook_InvoiceLineComponent, {
