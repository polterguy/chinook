...
/**
 * Modal dialog for editing your existing PlaylistTrack entity types, and/or
 * creating new entity types of type PlaylistTrack.
 */
@Component({
  templateUrl: './edit.chinook_PlaylistTrack.component.html'
})
export class EditChinook_PlaylistTrackComponent extends DialogComponent {

  /**
   * Constructor taking a bunch of services injected using dependency injection.
   */
  constructor(
    public dialogRef: MatDialogRef<EditChinook_PlaylistTrackComponent>,
    @Inject(MAT_DIALOG_DATA) public data: DialogData,
    protected snackBar: MatSnackBar,
    public service: HttpService) {
    super(snackBar);
    this.primaryKeys = ['PlaylistId', 'TrackId'];
    this.createColumns = [
      'PlaylistId',
      'TrackId'
    ];
  ...
  protected getCreateMethod() {
    return this.service.chinook_PlaylistTrack.create(this.data.entity);
  }
