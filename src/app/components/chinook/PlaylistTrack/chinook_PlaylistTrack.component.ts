...
import { EditChinook_PlaylistTrackComponent } from './modals/edit.chinook_PlaylistTrack.component';
import { HttpService } from 'src/app/services/http-service';
import { AuthService } from 'src/app/services/auth-service';

/**
 * "Datagrid" component for displaying instance of PlaylistTrack
 * entities from your HTTP REST backend.
 */
@Component({
  selector: 'app-chinook_PlaylistTrack',
  templateUrl: './chinook_PlaylistTrack.component.html',
  styleUrls: ['./chinook_PlaylistTrack.component.scss'],
  animations: [
...
export class Chinook_PlaylistTrackComponent extends GridComponent implements OnInit {
  ...
  public PlaylistId_Name: FormControl;
  public TrackId_Name: FormControl;
  public PlaylistId: FormControl;
  ...
  public entityBaseUrl() {
    return 'magic/modules/chinook/PlaylistTrack';
  }
  ...
  protected read(filter: any) {
    return this.httpService.chinook_PlaylistTrack.read(filter);
  }
  ...
  protected count(filter: any) {
    return this.httpService.chinook_PlaylistTrack.count(filter);
  }
  ...
  protected delete(ids: any) {
    return this.httpService.chinook_PlaylistTrack.delete(ids);
  }
  ...
  public ngOnInit() {
     ...
     * on our columns.
     */
    this.PlaylistId_Name = this.createFormControl('PlaylistId.Name.like');
    this.TrackId_Name = this.createFormControl('TrackId.Name.like');
    this.PlaylistId = this.createFormControl('PlaylistTrack.PlaylistId.eq');
    this.TrackId = this.createFormControl('PlaylistTrack.TrackId.eq');
  }
  ...
  public editEntity(entity: any) {
    ...
    const dialogRef = this.dialog.open(EditChinook_PlaylistTrackComponent, {
